...
public class RenshuFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_renshu, container, false);
    ...
    public void setEtRenshu() {
        ...
        if (TextUtils.isEmpty(num)) {
            Toast.makeText(getContext(), "台号不能为空", Toast.LENGTH_SHORT).show();
            return;
        }
